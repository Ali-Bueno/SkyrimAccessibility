...
Message Property AccessibilityMSGMQ101HadvarRalofSelectMenu Auto
...
Function AccessibilityMQ101StartSelect(Bool abMenu = True, Int aiButton = 0)
    While abMenu
        If aiButton != -1
            ...
            If aiButton == 0
                ...
                Game.GetPlayer().TranslateToRef(AccessibilityReferenceXMarkerHeading, 300)
                Utility.Wait(10.0)
                AccessibilityReferenceXMarkerHeading.SetPosition(18850.0, -77850.0, 8453.0)
                Game.GetPlayer().TranslateToRef(AccessibilityReferenceXMarkerHeading, 300)
                Utility.Wait(5.0)
...
Function AccessibilityMQ101HadvarRalofSelect(Bool abMenu = True, Int aiButton = 0)
    While abMenu
        If aiButton != -1
            aiButton = AccessibilityMSGMQ101HadvarRalofSelectMenu.Show()
            abMenu = False
            If aiButton == 0
                AccessibilityReferenceXMarkerHeading.SetPosition(14800.0, -79100.0, 8203.0)
                Game.GetPlayer().TranslateToRef(AccessibilityReferenceXMarkerHeading, 300)
                Utility.Wait(3.0)
            ElseIf aiButton == 1
                AccessibilityReferenceXMarkerHeading.SetPosition(15800.0, -77900.0, 8215.0)
                Game.GetPlayer().TranslateToRef(AccessibilityReferenceXMarkerHeading, 300)
                Utility.Wait(3.0)
            EndIf
        EndIf
