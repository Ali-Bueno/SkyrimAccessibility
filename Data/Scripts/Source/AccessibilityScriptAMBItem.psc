...
; Cached scan results per direction
...
; Single scan pass: 10 FindAll calls, categorize each object by direction
Function ScanAll(Actor Player)
    ...
    ScanType(Player, 46, AccessibilityAMBItemIngestible)
    ScanType(Player, 41, AccessibilityAMBItemWeapon)
    ScanType(Player, 42, AccessibilityAMBItemAmmo)
    ScanType(Player, 26, AccessibilityAMBItemArmor)
    ScanType(Player, 27, AccessibilityAMBItemBook)
    ScanType(Player, 45, AccessibilityAMBItemKey)
    ScanType(Player, 52, AccessibilityAMBItemSoulGem)
    ScanType(Player, 30, AccessibilityAMBItemIngredient)
    ScanType(Player, 23, AccessibilityAMBItemScroll)
    ScanType(Player, 32, AccessibilityAMBItemMisc)
EndFunction

; Scan one type, categorize each found object into direction buckets
